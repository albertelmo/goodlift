              ...
              ${trials.map(trial => {
                ...
                return `
                  <tr style="border-bottom:1px solid #f0f0f0;">
                    ...
                    <td style="padding:10px 8px;font-size:0.9rem;max-width:100px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="${trial.phone || ''}">${trial.phone || '-'}</td>
                    <td style="padding:10px 8px;font-size:0.9rem;max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="${trial.source || ''}">${trial.source || '-'}</td>
